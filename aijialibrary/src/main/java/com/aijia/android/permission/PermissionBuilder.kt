...
/**
 * More APIs for developers to control PermissionA functions.
 *
 * @author aijia
 * @since 2020/05/26
 */
class PermissionBuilder internal constructor(private val activity: FragmentActivity, internal val allPermissions: List<String>) {
    ...
    /**
     * Indicates should PermissionA explain request reason before request.
     */
     ...
     * If not called, requestCallback will be called by PermissionA automatically.
     */
    ...
    fun request(callback: RequestCallback) {
        ...
        for (permission in allPermissions) {
            if (PermissionA.isGranted(activity, permission)) {
